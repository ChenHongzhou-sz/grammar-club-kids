...
export const adjectiveGarden: GrammarUnit = {
  ...
  lessons: [
    ...
    ['comparative','比较级','两个人或东西比较，形容词常变比较级。','比较谁更高、更快、更大，就用 -er 或 more。','small -> smaller, beautiful -> more beautiful。','两个比较用 -er，长词 more 来帮忙。','taller','Tom is taller than Ben.','谁更高？','Tom'],
    ['superlative','最高级','三个或更多里最怎样，用最高级。','在一群里找“最”，常用 the + -est。','small -> the smallest, interesting -> the most interesting。','三个以上找第一，the 和 est 常一起。','the tallest','Amy is the tallest in class.','谁最高？','Amy']
