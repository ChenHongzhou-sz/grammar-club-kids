...
export const sentenceMaze: GrammarUnit = {
  ...
  lessons: [
    ...
    ['there-be','there be 句型','there be 表示“某地有某物”。','先说有，再说东西在哪里。','There is a book on the desk.','某地有物 there be，单数 is 复数 are。','is','There is a cat under the chair.','椅子下面有什么？','a cat'],
